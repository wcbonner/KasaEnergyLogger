...
deb: KasaEnergyLogger/usr/local/bin/kasaenergylogger KasaEnergyLogger/DEBIAN/control KasaEnergyLogger/usr/local/lib/systemd/system/kasaenergylogger.service
